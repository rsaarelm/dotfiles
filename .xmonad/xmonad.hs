...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    -- Restart xmonad
    , ((modMask              , xK_q     ), restart "/home/rsaarelm/local/bin/xmonad" True)

    -- Lock screen
    , ((modMask,               xK_F11), spawn "xscreensaver-command -lock")
    ]
    ++
...
--
--myLayout = tiled ||| Full
myLayout = avoidStruts $ TwoPane (3/100) (2/3) ||| Full ||| spiral (6/7)
  where
