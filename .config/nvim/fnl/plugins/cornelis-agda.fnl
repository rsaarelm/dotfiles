...
(vim.api.nvim_create_autocmd
  ...
  {:pattern [:agda] :callback (λ []
     (each [_ [bind cmd] (ipairs [
       ["<localleader>l" ":CornelisLoad"]
       ["<localleader>r" ":CornelisRefine"]
       ["<localleader>d" ":CornelisMakeCase"]
       ["<localleader>," ":CornelisTypeContext"]
       ["<localleader>." ":CornelisTypeContextInfer"]
       ["<localleader>n" ":CornelisSolve"]
       ["<localleader>a" ":CornelisAuto"]
